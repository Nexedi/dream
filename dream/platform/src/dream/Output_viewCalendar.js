...
(function (window, rJS, RSVP, $, scheduler,
           initGadgetMixin) {
  "use strict";
  ...
  gadget_klass
    ...
    scheduler.templates.event_class = function(start, end, event){
			...
			scheduler.parse([
				...
				{ start_date: "2012-06-30 4:00", end_date: "2012-06-30 15:00", text:"Task 1,3", section_id:'1,3'},
				{ start_date: "2012-06-30 16:00", end_date: "2012-07-01 17:00", text:"Task A-46598", section_id:'1'},

				{ start_date: "2012-07-04 00:00", end_date: "2012-07-04 23:00", text:"Task 2,3,4", section_id:'2,3,4'},
				{ start_date: "2012-07-01 02:00", end_date: "2012-07-01 16:00", text:"Task B-44864", section_id:'2'},

				{ start_date: "2012-07-06 02:00", end_date: "2012-07-06 18:00", text:"Task C-32421", section_id:'3'},
				{ start_date: "2012-07-02 08:30", end_date: "2012-07-02 19:45", text:"Task 3,1", section_id:'3,1'},


				{ start_date: "2012-06-30 11:40", end_date: "2012-07-02 16:30", text:"Task 4,2,3", section_id:'4,2,3'},
    ...
    .declareMethod("startService", function () {
      console.log('start', this.props.result);
			...
			scheduler.init(
			  $(this.props.element).find('#scheduler_here')[0],
			  new Date(2015, 3, 18),
			  "week");
